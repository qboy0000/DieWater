...
var GameLayer = cc.Layer.extend({
	...
	ctor:function(){
		...
		var w = size.width/2 - iconWidth*(this._verticalCount/2-0.5);
		var h = size.height/2 - iconHeight*(this._horizontalCount/2-0.5);
        ...
        this._scoreLabel.attr({
               x:size.width/4,
               y:size.height/2+iconHeight*(this._horizontalCount+1)/2
            });
    ...
    onTouchEnded:function(touch,event){
        ...
        if(me._blMoving)
        {
            ...
            me._scoreLabel.setString("Score:"+me._score);
            me._moveCountLabel.setString("Move:"+me._moveCount);
        }
    },
